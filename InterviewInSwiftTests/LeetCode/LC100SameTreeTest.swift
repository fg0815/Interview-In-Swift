...
class LC100SameTreeTest: XCTestCase {
    ...
    func testIsSame() {
        XCTAssert(case1().expectedResult == LC100SameTree.isSameTree(case1().inputA, q: case1().inputB))
        XCTAssert(case2().expectedResult == LC100SameTree.isSameTree(case2().inputA, q: case2().inputB))
    }
